...
class EquipierInline(admin.StackedInline):
    ...
    fieldsets = (
        ...
        (None, { 'classes': ('wide', ), 'fields': (('date_de_naissance', 'age', ), ('autorisation_detail', 'autorisation'), ('justificatif', 'num_licence', ), ('piece_jointe_detail', 'piece_jointe', 'cerfa_valide')) }),
    )
