...
urlpatterns += [
    ...
    path(r'<str:course_uid>/<int:numero>/facture/thankyou/', views.contact_done, name='contact_done'),
    path(r'<str:course_uid>/<int:numero>/facture/<str:code>/', views.facture, name='inscriptions_facture'),
    path('<str:course_uid>/stripe/webhook/', views.stripe_webhook, name='inscriptions_stripe_webhook'),
    path('<str:course_uid>/helloasso/webhook/', views.helloasso_webhook, name='inscriptions_helloasso_webhook'),
    path(r'<str:course_uid>/intent/<str:methode>/', views.intent_paiement, name='inscriptions_intent_paiement'),
